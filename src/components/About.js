...
const About = () => {
  return (
    <div>
      ...
      <div>
        Welcome to our youtube clone app. It lets you search for YouTube videos,
      ...
      <div>
        <div>
          ...
          />
          <p>
            I am an asipiring full stack developer with a passion for wildlife,
            space exploration, and baseball. When im not staring up at the sky,
            watching wildlife docu series, or playing baseball, I practice
            coding and Hope to gain a position as a developer with a company
            actively trying to better our world.
          </p>
